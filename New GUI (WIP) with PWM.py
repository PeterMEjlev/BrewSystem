...
# =============================================================================
    ...
    def initDynamicGUI(self):
        ...
        self.btn_title_heating = QLabel(self)
        self.btn_title_heating.setPixmap(QPixmap(imagePath + "title_heating.png").scaled(318, 82, transformMode = Qt.SmoothTransformation))
        self.btn_title_heating.move(235,11)
        self.btn_title_heating.adjustSize()
        self.btn_title_heating.mousePressEvent = self.showMashingWindow
        ...
        MainWindow.btn_pumps = QLabel(self)
        MainWindow.btn_pumps.setPixmap(QPixmap(imagePath + "btn_pump.png").scaled(104, 72, transformMode = Qt.SmoothTransformation))
        MainWindow.btn_pumps.move(16,11)
        MainWindow.btn_pumps.adjustSize()
        MainWindow.btn_pumps.mousePressEvent = showPumpsWindow
        
        #showPumpsWindow(MainWindow)

        MainWindow.indicator_B = QLabel(self)
        ...
        MainWindow.indicator_B.move(129,11)
        MainWindow.indicator_B.adjustSize()
        
        MainWindow.indicator_H = QLabel(self)
        ...
        MainWindow.indicator_H.move(179,11)
        MainWindow.indicator_H.adjustSize()
        
        MainWindow.increment = QLabel(self)
        MainWindow.increment.setPixmap(QPixmap(imagePath + "increment_1.png").scaled(104, 72, transformMode = Qt.SmoothTransformation))
        MainWindow.increment.move(564,11)
        MainWindow.increment.adjustSize()
        MainWindow.increment.mousePressEvent = changeIncrementAmount
        
        #Boil Kettle
        print("BK")
        MainWindow.btn_up_bk_temp = QLabel(self)
        MainWindow.btn_up_bk_temp.setPixmap(QPixmap(imagePath + "btn_up.png").scaled(70, 70, transformMode = Qt.SmoothTransformation))
        MainWindow.btn_up_bk_temp.move(28,184)
        MainWindow.btn_up_bk_temp.adjustSize()
        MainWindow.btn_up_bk_temp.mousePressEvent = increase_BK_SV
        MainWindow.btn_up_bk_temp.mouseReleaseEvent = increase_BK_SV
